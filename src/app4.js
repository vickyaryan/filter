...
function App() {
  ...
  const inputText = (e) => {
    ...
    console.log('jjjjjj',e.target.value,filterData);
    ...
    setFilterData(data);
    console.log('jjjjjj11111111',e.target.value,filterData);
  };
  
  // useEffect(() => {
  //   console.log('jjjjjj',checked);
  // },[checked])

  // useEffect(() => {
  //   console.log('jjjjjj',filterData);
  //   setFilterData(datafil)
  //   inputText()
  // },[athlete])
  const dateFilter = (e) => {
          ...
          <tr>
            ...
            <th scope="col">
              <div style={{ display: "flex" }}>
                <p>{selectData}</p>
                <Text onChange={inputText} value={athlete} data={conditionData} setSelectData={setSelectData}/>
            ...
            <div className="btn-group" style={{ marginRight: 10 , alignItems: "center" }}>
             ...
             {/* <Date value1={secSelectDate} selectDate={selectDate} onChange1={(e)=>setSecSelectDate(e.target.value)} onChange2={dateFilter}  value2={fsSelectDate}/> */}
            <div style={{ display: "flex" }}>
